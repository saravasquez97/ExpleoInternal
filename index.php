...
header("Location: src/modules/sign_in/sign_in_view.php");

$_SESSION['success'] = null;
$_SESSION['errorMessage'] = null;
?>
<!-- This page removed by Lexi because it looked ugly -->
    ...
    <body>
        ...
        <div>
            <div class="welcome">
                ...
                <button class="btn btn-light" id="LoginBut" onclick="location.href='src/modules/sign_in/sign_in_controller.php'">Sign In</button>
