...
<div id="heading2">
    ...
    <nav class="navbar navbar-expand-md fixed-top">
        ...
        <a class="navbar-brand" href="#"><img style="width: 9.0625rem;" src="../../../assets/img/expleo-logo-white.png" class="figure-img img-fluid rounded" width="45" height="45" alt="The SQS company logo."></a>
